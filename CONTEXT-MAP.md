...
- [Bobby](./apps/bobby/CONTEXT.md) — Operator business co-pilot agent (Eve); not Portal UI
...
- **Bobby → Portal / backend**: Bobby tools call Operator-scoped practice APIs; Portal remains the workspace chrome (Client Desk / Operator Home). Bobby does not host Client chat.

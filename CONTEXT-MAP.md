...
- [Portal](./apps/portal/CONTEXT.md) — signed-in Hezaerd tools / account surface
...
- **Portal ↔ Brand / Portfolio**: Portal is the authenticated app. It may link out to Brand or Portfolio; it does not host their public content.

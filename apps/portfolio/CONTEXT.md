...
**Project**:
A named piece of personal craft in the archive (study project, experiment, mod, game, tool, creative work). Disjoint from Brand Work. May include meta work such as building the person’s own sites — including the narrative of building the company-facing Brand site — framed as maker craft, not as Brand Work.
_Avoid_: Case study (Brand sense), listing client engagements as Projects

**Person**:
Hezaerd as the individual maker, distinct from Hezaerd the company on Brand.
_Avoid_: Practice, company, agency voice on this site
...
_Avoid_: Modal-only deep dives with no stable address; turning Portfolio into a Brand-style multi-page brochure

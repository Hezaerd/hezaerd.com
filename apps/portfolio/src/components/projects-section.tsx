              ...
              >
                <div className="relative h-40 shrink-0 overflow-hidden">
                  {project.previewImage ? (
                    ...
                    <div className="from-primary via-primary/90 to-primary/70 text-primary-foreground flex h-full items-center justify-center bg-gradient-to-br p-4 text-center text-lg font-bold">
